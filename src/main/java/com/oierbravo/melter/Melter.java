...
import com.oierbravo.melter.infrastructure.ponder.ModPonderPlugin;
...
public class Melter
{
    ...
    public Melter(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        registrate().addRawLang("melter.ponder.melter.header", "Processing Items in the Melter");
        registrate().addRawLang("melter.ponder.melter.text_1", "Transforms blocks into fluids");
        registrate().addRawLang("melter.ponder.melter.text_2", "They can be heated from the below using different heat sources");
        registrate().addRawLang("melter.ponder.melter.text_3", "Throw items at the top or insert from the sides");
        registrate().addRawLang("melter.ponder.melter.text_4", "Outputs can be extracted by automation");
